...
namespace personalised_concierge_m1.Controllers
{
    public class CalendarEventController : Controller
    {
        ...
        private CalendarEvent setCalendarEventObject(string name, string location, string type, string description, string date, string startTime, string endTime, string note, int otherId)
        {
            ...
            calendarEvent.OtherId = otherId;
            return calendarEvent;
        }

        private CalendarEvent setCalendarEventObjectWithId(int id, string name, string type, string location, string description, string date, string startTime, string endTime, string note, int otherId)
        {
            DateTime startDateTime = convertStringToDateTime(date + " " + startTime);
            DateTime endDateTime = convertStringToDateTime(date + " " + endTime);
